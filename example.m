...
%specifying inputs
target_train_name = 'spike_train_ex1'; % spike trains to fit network model to. Here we use a spike train generated by the spatial balanced network as an example. 
...
Ne = 2500; % number of E neurons in the read-out layer

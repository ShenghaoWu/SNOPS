...
N_groundtruth=50000;
N_factor=sqrt(Ntotal/N_groundtruth);
...
%%%rescaling rescaling connectivity strength


%Jxs=[140; 100]*N_factor; 


%%GROUND TRUTH


%filename='./results/network_opt.mat';
%Ntotal=Ne1*Ne1+Ni1*Ni1;

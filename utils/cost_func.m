function [objective] = cost_func(x, is_surrogate, obj_configs, simulator)
%compute the cost given a parameter set x, configurations, and a network
%simulator
%input_para: [1, number of parameters to optimize]
%is_surrogate: if surrogate simulation (cheaper run for freeze-thaw
%optimization) is needed
%obj_configs: configuration struct for the optimization
%simulator: network simulator. See SBN.m
